...
importers:
  ...
  .:
    dependencies:
      ...
      mysql2:
        specifier: ^3.22.4
        version: 3.22.4(@types/node@25.9.1)
      sequelize:
        specifier: ^6.37.8
        version: 6.37.8(mysql2@3.22.4(@types/node@25.9.1))
...
snapshots:
  ...
  mysql2@3.22.4(@types/node@25.9.1):
    dependencies:
      '@types/node': 25.9.1
      aws-ssl-profiles: 1.1.2
      denque: 2.1.0
  ...
  sequelize@6.37.8(mysql2@3.22.4(@types/node@25.9.1)):
    dependencies:
      '@types/debug': 4.1.13
      '@types/validator': 13.15.10
      debug: 4.4.3
